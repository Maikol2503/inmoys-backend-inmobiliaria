...
#             # imagenes_nuevas = Property(imagenes={f'imagenes':ima})
#             # db.add(imagenes_nuevas)
#             imagenes_guardadas.append({'id':i, 'image':image_name})
...
#         imagenes_nuevas = Property(imagenes={f'imagenes':imagenes_guardadas})
#         db.add(imagenes_nuevas)
#         # Confirmar los cambios en la base de datos
#         db.commit()
#         # Retornar las imágenes guardadas
#         return {"status": "success", "imagenes": imagenes_nuevas}
